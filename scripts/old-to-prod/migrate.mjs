...
function buildPipeline() {
  const all = [
    ...
    { script: '06_import_prod.mjs',       name: 'import',          forward: ['dry-run', 'auth-only', 'public-only', 'resume', 'clean-prod', 'clean-auth', 'confirm', 'allow-overwrite', 'overwrite', 'batch-size', 'export-dir', 'use-mcp-preflight', 'allow-import-dedup-for-rehearsal'] },
