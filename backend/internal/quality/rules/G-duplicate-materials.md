...
> **Выключено 2026-09-16**, заменено правилом **GA**: дубли только при одной работе и одной
> детальной категории затрат. G давал 11 886 групп в 99 тендерах, большинство —
> законный повтор материала под разными работами.
...
- FP: «Большая Татарская» — краска ПФ-115 и уайт-спирит (по 17 групп), стеклопакеты
  (21 группа): одна цена, разные работы. Сужение — черновик **GA**.
- TP-кандидат: там же KTV-3A-3600 по 2 строки в 6 позициях — импорт или две двери;
  без сверки РД не закрывать автоматом.

## Замер (2026-07-24)

9 192 группы дублей в 80 тендерах.

Срез (2026-09-16): «Большая Татарская» — 108 групп, UI-деньги ~94 млн (оценка сверху).
14 уникальных наименований; топ по деньгам — двери KTV и субстрат озеленения.
