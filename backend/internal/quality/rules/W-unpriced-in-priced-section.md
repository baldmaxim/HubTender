...
База 104 тендера: 833 находки в 75 тендерах. Оставлено черновиком: смысл «пропущенная
строка в расценённом разделе» теперь покрывает правило **V** (раздел расценён не меньше
чем наполовину, у позиции нет обоснования). W, в отличие от V, срабатывает и на
позиции с обоснованием — это как раз законно не расценённые строки.
