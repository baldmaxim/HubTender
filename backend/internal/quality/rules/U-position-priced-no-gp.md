...
- TP: «Большая Татарская» — 21 находка (20× вердикт `error`): кластеры 123–126,
  809–819, 867–870 совпадают с крупными A — сначала заполнять Кол-во ГП, потом
  разбирать количества материалов.
